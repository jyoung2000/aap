...
def upgrade() -> None:
    ...
    sa.Column('confirmation_screenshot', sa.String(length=1024), nullable=False),
    sa.Column('error', sa.Text(), nullable=False),
    sa.Column('error_screenshot', sa.String(length=1024), nullable=False),
    ...
    sa.Column('options', sa.JSON(), nullable=False),
    sa.Column('question', sa.Text(), nullable=False),
    sa.Column('screenshot', sa.String(length=1024), nullable=False),
    sa.Column('answer', sa.Text(), nullable=False),
